...
Quattro casi reali, di registri e scale diverse, mostrano l'assioma 18 in azione su collassi avvenuti.

**Il processo a Galileo Galilei (Roma, 1633).** Il 22 giugno 1633, davanti al tribunale dell'Inquisizione, Galileo abiura formalmente l'eliocentrismo difeso nel *Dialogo sopra i due massimi sistemi del mondo* (1632). Il caso è esemplare della distinzione fra coerenza strutturale in sistemi ordinativi diversi. Nel sistema fisico-osservativo, l'eliocentrismo era *strutturalmente vero*: alta coerenza orizzontale (compatibile con le osservazioni telescopiche delle fasi di Venere, dei satelliti di Giove, delle macchie solari), alta coerenza verticale (compatibile con la fisica copernicano-keplero-galileiana), alta coerenza trasversale (riscontri empirici crescenti). Nel sistema teologico-aristotelico-tomistico in cui operava il tribunale, la stessa proposizione era *strutturalmente falsa*: incoerente con i principi cosmologici (cielo immobile, Terra al centro), incoerente con certi passi biblici (Giosuè 10:12-13). Il processo del 1633 non è caso di "verità contro errore" ma di tensione fra coerenze strutturali in sistemi distinti. La storia successiva ha visto il sistema fisico ampliare il proprio dominio fino a contenere fenomeni che il sistema teologico-cosmologico non poteva rappresentare — ma la riabilitazione formale di Galileo dovette aspettare il pronunciamento di Giovanni Paolo II (31 ottobre 1992).

**Il caso Lysenko nella biologia sovietica (1948-1965).** Trofim Lysenko, agronomo, impose dal 1948 una "biologia sovietica" che rifiutava la genetica mendeliana come "borghese" e proponeva l'eredità dei caratteri acquisiti come fondamento dell'agricoltura socialista. Il sistema era *internamente coerente* (alta coerenza orizzontale fra le proprie proposizioni) e *coerente verticalmente* con la dottrina marxista-leninista (la genetica come dialettica materiale). Mancava la coerenza trasversale: i campi esterni (rese agricole reali, produzione di grano) producevano riscontri opposti alle predizioni. Per quasi due decenni, mentre i genetisti sovietici venivano arrestati o esiliati (Vavilov morto in carcere nel 1943), le politiche agricole basate sul lysenkismo contribuirono a carestie ricorrenti. Il sistema fu smantellato nel 1965 dopo la caduta di Krushchev. Caso storico esemplare di sistema ordinativo che teneva due componenti su tre, e fallì sulla terza — con conseguenze umane misurabili in milioni di vittime.

**Wikipedia come sistema epistemico ordinativo (2001-presente).** Lanciata il 15 gennaio 2001 da Jimmy Wales e Larry Sanger, Wikipedia ha articolato strutturalmente le tre componenti della verità ordinativa attraverso i *Five Pillars* (codificati nel 2005): neutralità del punto di vista, verificabilità tramite fonti, niente ricerca originale, codice di condotta, libertà di modifica. Coerenza orizzontale: le voci si referenziano reciprocamente, con sistemi di link interni e categorie. Coerenza verticale: i Pilastri come principi strutturali a cui ogni voce deve sottostare. Coerenza trasversale: le citazioni a fonti esterne come ancoraggio al campo conosciuto. Wikipedia non pretende neutralità ingenua né accetta relativismo soft; opera come sistema ordinativo specifico con propria grammatica della verità. Casi di vandalismo, edit war, controversie BLP (*biographies of living persons*) sono ricondotti alla struttura attraverso i meccanismi di patrolling. La sua affidabilità documentata (*Nature* 2005, confronto con Encyclopædia Britannica) deriva precisamente dal funzionamento articolato delle tre componenti.

**Le citazioni accademiche inventate da GPT-4.** Documentato in molteplici studi (Stanford HAI 2023, *Nature* 2024), un fallimento caratteristico dei modelli linguistici è la fabbricazione di citazioni accademiche plausibili: nomi di autori reali, riviste reali, anni plausibili, ma articoli che non esistono. Strutturalmente: la risposta è alta in coerenza orizzontale (sembra coerente con il resto della risposta del modello), può essere alta in coerenza verticale (segue i pattern formali della scrittura accademica del corpus medico/scientifico), ma è bassa in coerenza trasversale (la citazione non corrisponde a fatti del campo esterno). Il fenomeno è la manifestazione operativa di ciò che l'assioma 18 chiama mancanza di coerenza trasversale, e giustifica strutturalmente la nota canonica del TE_CORE: *sviluppare un controllore di coerenza interno*. Le architetture *retrieval-augmented generation* (RAG) e i sistemi di citation verification (Anthropic 2024, OpenAI 2024) lavorano esattamente per ridurre questo gap fra plausibilità statistica e coerenza strutturale piena.
